...
<div id="wrapper">
  <div id="inner">
    <div id="header">
      <h1><img src="resources/logo.gif" width="519" height="63" alt="Online Movie Store" /></h1>
      ...
      <!-- end nav -->
      <a href="http://www.free-css.com/"><img src="resources/header_1.jpg" width="744" height="145" alt="Harry Potter cd" /></a> <a href="http://www.free-css.com/"><img src="resources/header_2.jpg" width="745" height="48" alt="" /></a> </div>
    <!-- end header -->
    <dl id="browse">
      ...
      <dd class="searchform">
        <form action="http://www.free-css.com/" method="get">
          ...
          <div class="softright">
            <input type="image" src="resources/btn_search.gif" />
          </div>
        </form>
      </dd>
    </dl>
    <div id="body">
      <div class="inner">
        <div class="leftbox">
          ...
          <img src="resources/photo_1.jpg" width="93" height="95" alt="photo 1" class="left" />
        ...
        <div class="rightbox">
          ...
          <img src="resources/photo_4.jpg" width="107" height="91" alt="photo 4" class="left" />
        ...
        <div class="leftbox">
          ...
          <img src="resources/photo_2.jpg" width="93" height="101" alt="photo 2" class="left" />
        ...
        <div class="rightbox">
          ...
          <img src="resources/photo_5.jpg" width="90" height="103" alt="photo 5" class="left" />
        ...
        <div class="leftbox">
          ...
          <img src="resources/photo_3.jpg" width="106" height="100" alt="photo 3" class="left" />
        ...
        <div class="rightbox">
          ...
          <img src="resources/photo_6.jpg" width="91" height="99" alt="photo 6" class="left" />
